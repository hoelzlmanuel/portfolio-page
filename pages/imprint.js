...
export default () => (
  <Layout>
    ...
    <div className="p-8 overflow-x-auto">
      ...
      <p>Ober Neustift 52, <br />3920 Groß Gerungs, <br />Österreich</p>
      <p>
        <strong>Tel.:</strong> +43 664 21 30 752<br />
        <strong>E-Mail:</strong> <a className="font-semibold link link-black" href="mailto:manuel@hoelzl.dev">manuel@hoelzl.dev</a>
      </p>

      <h2 className="heading text-2xl md:text-4xl font-extrabold w-full my-6">
      ...
      <p>Gemäß Verordnung über Online-Streitbeilegung in Verbraucherangelegenheiten (ODR-Verordnung) möchten wir Sie über die Online-Streitbeilegungsplattform (OS-Plattform) informieren.<br />
        Verbraucher haben die Möglichkeit, Beschwerden an die Online Streitbeilegungsplattform der Europäischen Kommission unter <a className="font-semibold link link-black" href="https://ec.europa.eu/consumers/odr/main/index.cfm?event=main.home2.show&lng=DE" target="_blank" rel="nofollow">http://ec.europa.eu/odr?tid=221120348</a> zu richten. Die dafür notwendigen Kontaktdaten finden Sie oberhalb in unserem Impressum.</p>
      ...
      <p>Unsere Webseite enthält Links zu anderen Webseiten für deren Inhalt wir nicht verantwortlich sind. Haftung für verlinkte Websites besteht laut <a className="font-semibold link link-black" href="https://www.ris.bka.gv.at/Dokument.wxe?Abfrage=Bundesnormen&Dokumentnummer=NOR40025813&tid=221120348" target="_blank" rel="noopener nofollow">§ 17 ECG</a> für uns nicht, da wir keine Kenntnis rechtswidriger Tätigkeiten hatten und haben, uns solche Rechtswidrigkeiten auch bisher nicht aufgefallen sind und wir Links sofort entfernen würden, wenn uns Rechtswidrigkeiten bekannt werden.</p>
      ...
      <h2 className="heading text-2xl md:text-4xl font-extrabold w-full my-6">
        Urheber&shy;rechts&shy;hinweis
      </h2>
      ...
      <h1 className="heading text-3xl md:text-5xl font-extrabold w-full my-6">
      ...
      <p>Wir haben diese Datenschutzerklärung (Fassung 24.03.2020-221120348) verfasst, um Ihnen gemäß der Vorgaben der <a className="font-semibold link link-black" href="https://eur-lex.europa.eu/legal-content/DE/ALL/?uri=celex%3A32016R0679&tid=221120348" target="_blank" rel="noopener nofollow">Datenschutz-Grundverordnung (EU) 2016/679</a> zu erklären, welche Informationen wir sammeln, wie wir Daten verwenden und welche Entscheidungsmöglichkeiten Sie als Besucher dieser Webseite haben.</p>
      <p>Leider liegt es in der Natur der Sache, dass diese Erklärungen sehr technisch klingen, wir haben uns bei der Erstellung jedoch bemüht die wichtigsten Dinge so einfach und klar wie möglich zu beschreiben.</p>
      <h2 className="heading text-2xl md:text-4xl font-extrabold w-full my-6">
        TLS-Verschlüsselung mit https
      </h2>
      <p>Wir verwenden https um Daten abhörsicher im Internet zu übertragen (Datenschutz durch Technikgestaltung <a className="font-semibold link link-black" href="https://eur-lex.europa.eu/legal-content/DE/TXT/HTML/?uri=CELEX:32016R0679&from=DE&tid=221120348" target="_blank" rel="noopener nofollow">Artikel 25 Absatz 1 DSGVO</a>). Durch den Einsatz von TLS (Transport Layer Security), einem Verschlüsselungsprotokoll zur sicheren Datenübertragung im Internet können wir den Schutz vertraulicher Daten sicherstellen. Sie erkennen die Benutzung dieser Absicherung der Datenübertragung am kleinen Schlosssymbol links oben im Browser und der Verwendung des Schemas https (anstatt http) als Teil unserer Internetadresse.</p>
      <h2 className="heading text-2xl md:text-4xl font-extrabold w-full my-6">
        Rechte laut Da&shy;ten&shy;schutz&shy;grund&shy;ver&shy;ord&shy;nung
      </h2>
      <p>Ihnen stehen laut den Bestimmungen der DSGVO und des österreichischen <a className="font-semibold link link-black" href="https://www.ris.bka.gv.at/GeltendeFassung.wxe?Abfrage=Bundesnormen&Gesetzesnummer=10001597&tid=221120348" target="_blank" rel="noopener nofollow">Datenschutzgesetzes (DSG)</a> grundsätzlich die folgende Rechte zu:</p>
      ...
      <p>Wenn Sie glauben, dass die Verarbeitung Ihrer Daten gegen das Datenschutzrecht verstößt oder Ihre datenschutzrechtlichen Ansprüche sonst in einer Weise verletzt worden sind, können Sie sich bei der Aufsichtsbehörde beschweren, welche in Österreich die Datenschutzbehörde ist, deren Webseite Sie unter <a className="font-semibold link link-black" href="https://www.dsb.gv.at/?tid=221120348" rel="nofollow">https://www.dsb.gv.at/</a> finden.</p>
