...
import withWindowDimensions from './withWindowsDimensions'
  ...
  render() {
    return (
      <div className={`${this.state.showMenu && this.props.screenNotLarge ? "text-white" : "text-black"}`}>
        <nav className={`flex items-center justify-between flex-wrap py-6 pl-6 ${this.props.screenNotLarge && this.state.showMenu && "bg-middle"} ${this.props.screenNotLarge && "pr-6"}`}>
